;; 1. Based on: 100
;; 2. Description: 
;;    PK model 1 cmt - WT-CL allometry
;; 3. Label:
;;    
;; 4. Structural model:
;; 5. Covariate model:
...
$TABLE ID TIME DV MDV EVID IPRED IWRES CWRES ONEHEADER NOPRINT FILE=sdtab102
$TABLE ID CL V KA ETAS(1:LAST) ONEHEADER NOPRINT FILE=patab102
